...
def evaluate():
    ...
    print("\n--- STATS ---")
    print(f"Avg Real Prob: {sum(real_probs)/len(real_probs):.4f} (expected < 0.5)")
    print(f"Avg AI Prob: {sum(ai_probs)/len(ai_probs):.4f} (expected > 0.5)")
