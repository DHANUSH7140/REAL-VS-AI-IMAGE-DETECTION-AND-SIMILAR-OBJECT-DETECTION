...
new_func = '''def download_ai_images(output_dir: str, count: int) -> str:
    ...
    # We will download sequentially until we have enough.
    part = 1
...
# Find the start and end of the current download_ai_images function
content = re.sub(r'def download_ai_images\(output_dir: str, count: int\) -> str:.*?return ai_dir\n', new_func + '\n', content, flags=re.DOTALL)
